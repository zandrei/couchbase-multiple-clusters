...
/**
 * Annotation to activate reactive couchbase repositories. If no base package is configured through
 * either {@link #value()}, {@link #basePackages()} or {@link #basePackageClasses()} it will trigger
...
@Documented
@Inherited
@Import(SampleReactiveCouchbaseRepositoriesRegistrar.class)
public @interface EnableSampleReactiveCouchbaseRepositories {

    /**
     * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation
     * declarations e.g.: {@code @EnableReactiveCouchbaseRepositories("org.my.pkg")} instead of
     * {@code @EnableReactiveCouchbaseRepositories(basePackages="org.my.pkg")}.
     */
    String[] value() default {};

    /**
     * Base packages to scan for annotated components. {@link #value()} is an alias for (and
     * mutually exclusive with) this attribute. Use {@link #basePackageClasses()} for a type-safe
     ...
     * a special no-op marker class or interface in each package that serves no purpose other than
     ...
     * default to {@code META-INFO/couchbase-named-queries.properties}.
     *
     * @return
     */
    ...
    /**
     * Configure the repository base class to be used to create repository proxies for this
    ...
    Class<?> repositoryFactoryBeanClass() default
            SampleReactiveCouchbaseRepositoryFactoryBean.class;
    ...
    /**
     * Configures the name of the {@link CouchbaseTemplate} bean to be used by default with the
